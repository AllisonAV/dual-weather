...
// when user clicks, add marker to map, and add the lat and log to the state markers array
  ...
  getWeather = function() {
    let param1 = `${this.state.markers[0].lat},${this.state.markers[0].lng}`
    let param2 = `${this.state.markers[1].lat},${this.state.markers[1].lng}`
    ...
    return (
      <div>
        <button className="btn btn-primary"
                  onClick={this.getWeather} > Weather
        </button>
        <div id="map">
        </div>
      </div>
